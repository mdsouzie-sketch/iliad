...
window.SITE_CONTENT = {
    ...
    pricing: {
        ...
        programs: {
            number: "TIER II",
            title: "Programs",
            lead: "Ongoing training built from your assessment data. Monthly subscriptions or per-session bookings, cancel anytime. <strong>From $50/month</strong> depending on program and frequency.",
            coachingHead: "Performance Coaching",
            coachingProse: "<strong>$300 / month.</strong> Weekly 1:1 coached sessions, sport-specific programming, continuous data tracking, re-tests every 4–6 weeks. For competitive athletes whose performance has measurable consequences.",
            trainingHead: "Personal Training",
            trainingProse: "<strong>$60 per session.</strong> General strength training built on your diagnostic foundation, for adults who want to train seriously without competition prep. Pay per session or buy session packs.",
            correctiveHead: "Corrective Exercise",
            correctiveProse: "<strong>$50 / month</strong> for a focused 4–12 week block. Targeted intervention for the asymmetries the screen revealed; runs alongside another program until the patterns clear.",
