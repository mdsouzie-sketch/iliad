...
window.SITE_CONTENT = {
    ...
    pricing: {
        ...
        programs: {
            ...
            lead: "Programs are calibrated to your data. Two athletes with the same goal often get very different prescriptions — and very different prices. Once we've reviewed your assessment results, we'll discuss which program fits, what cadence makes sense, and what it costs. The conversation happens during your 30-minute results consult, included with the assessment.",
            coachingHead: "Performance Coaching",
            coachingProse: "Weekly 1:1 coached sessions, sport-specific programming, continuous data tracking, re-tests every 4–6 weeks. For competitive athletes whose performance has measurable consequences.",
            trainingHead: "Personal Training",
            trainingProse: "General strength training built on your diagnostic foundation, for adults who want to train seriously without competition prep. Per-session or session packs.",
            correctiveHead: "Corrective Exercise",
            correctiveProse: "Targeted intervention for the asymmetries the screen revealed; runs alongside another program until the patterns clear. Typically a focused 4–12 week block.",
        ...
        faq: {
            ...
            q2Head: "Why isn't program pricing on this page?",
            q2Prose: "Because programs aren't one-size. Two athletes with the same goal often get very different prescriptions, and pricing follows what the program needs to do. Once we have your assessment data, we can recommend the right program and quote a fair number — that conversation happens during your results consult.",
